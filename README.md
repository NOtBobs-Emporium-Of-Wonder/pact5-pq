...
* **not_bob & seal_klub** (`long_live the empire`) — Post-quantum SLH-DSA architecture, FIPS 205 reference verification, `q:`/`x:` principals, and formal verification test suites.
